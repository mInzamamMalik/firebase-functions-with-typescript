...
function makeDevEntity(entityName, entries) {
...
exports.makeDevEntity = makeDevEntity;
function makeUserEntity(sessionId, entityName, entries) {
    return new Promise((resolve, reject) => {
...
function makeUserEntityWithArray(sessionId, entityName, entries, isDry = false) {
    return new Promise((resolve, reject) => {
        let entityEntry = [];
...
exports.makeUserEntityWithArray = makeUserEntityWithArray;
